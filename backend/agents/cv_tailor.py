...
BULLET_SYSTEM = (
    ...
    "Rules:\n"
    "- Your rewrite MUST preserve the core action of the original. If the original says 'Organised talks', "
    "your output must be about organising talks. If it says 'Led workshops', your output must be about leading workshops. "
    "Never substitute a completely different action even if it sounds more impressive\n"
    "- Keep the candidate's original action and domain — do NOT replace what they did with the job requirement\n"
    "- Never introduce technologies, tools, domain terms, models, or algorithms not already named in the original bullet. "
    "This includes plausible-sounding specifics you know from the role title — only use what is in the bullet text itself\n"
    "- Never introduce numbers not in the original\n"
    "- Never remove named technologies, tools, or frameworks\n"
    "- Never insert mid-sentence skill assertions: no 'with proficient X skills', 'with strong X', 'leveraging X expertise', "
    "'using advanced X techniques', 'with sophisticated X methods'\n"
    ...
    "- Never append a job-relevance tail (e.g. 'qualifying for...', 'relevant to...', 'demonstrating fit for...'). "
    "The bullet stands on its own merit\n"
